...
class DefaultBottleAdapter(private val context: Context, private val listener: (Bottle) -> Unit) :
    RecyclerView.Adapter<DefaultBottleAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(private val view: View) : RecyclerView.ViewHolder(view) {
        ...
        private val image = view.img_choose_bottle_size
